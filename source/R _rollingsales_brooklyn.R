...
setwd("C://proj//MSDS6306//MSDS6306_Homework4")

bk <- read.csv("data/rollingsales_brooklyn.csv",skip=4,header=TRUE) # This was done due to being on Windows and not have a perl interpreter installed - need to do more research about this.
...
rmarkdown::render("paper/brief_explain.Rmd")
